...
pygame.init()
pygame.display.set_caption("BS_simulator <Entropy>")
...
while running:
  ...
  for i in range(len(carsprites)):
    ...
    draw_line(screen,(0,0,0),(carsprites[i].rect.centerx,carsprites[i].rect.centery),(BS_sprites[BS_now].rect.centerx,BS_sprites[BS_now].rect.centery),2)
    draw_car_text(screen,str(int(DB_MAX))+" dB,"+str(int(carsprites[i].DB))+" dB",15,carsprites[i].rect.centerx-20,carsprites[i].rect.centery)
